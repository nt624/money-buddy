...
func (m *setupFixedCostRepoMock) DeleteFixedCostsByUser(ctx context.Context, userID string) error {
	args := m.Called(ctx, userID)
	return args.Error(0)
}

func (m *setupFixedCostRepoMock) BulkCreateFixedCosts(ctx context.Context, userID string, fixedCosts []FixedCostItem) error {
