...
開発初期にペルソナ（お金の現状把握が苦手なユーザー）を深く分析しました。「高機能な家計簿」ではなく「開いた瞬間に現状を把握できるツール」が必要だと定義し、**あえて「細かい分析機能」をMVPから削り、「残額表示」に特化**させました。この「迷ったらユーザーの安心感に立ち返る」という指針があったため、ブレずに開発を完遂できました。
